        ...
        <section className="py-24">
          <div className="mx-auto grid max-w-7xl items-center gap-16 px-6 lg:grid-cols-2">
            ...
            <div className="relative h-[450px] overflow-hidden rounded-3xl shadow-lg">
              <Image src="/living.jpeg" alt="" fill className="object-cover" />
            </div>
          </div>
        </section>
        ...
        <section className="pb-24">
          <div className="mx-auto max-w-7xl px-6">
            ...
            <div className="mt-14 grid gap-8 md:grid-cols-3">
              {highlights.map((item) => (
                <div  key={item.title} className="rounded-3xl bg-white p-8 shadow-md transition hover:-translate-y-2">
          ...
          <div className="mx-auto max-w-7xl px-6">
            ...
            <div className="mx-auto mt-14 grid max-w-5xl gap-6 md:grid-cols-2">
              {services.map((service) => (
                <div key={service} className="flex items-center gap-4 rounded-xl bg-white p-5 shadow-sm">
